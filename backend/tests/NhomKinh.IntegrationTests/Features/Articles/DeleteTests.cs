...
using NhomKinh.IntegrationTests.Features.Comments;
using NhomKinh.IntegrationTests.Features.Users;
using NhomKinh.Features.Articles;

namespace NhomKinh.IntegrationTests.Features.Articles
{
    public class DeleteTests : SliceFixture
    {
        ...
        public async Task Expect_Delete_Article_With_Comments()
        {
            ...
            var createCommentCmd = new NhomKinh.Features.Comments.Create.Command()
            {
                Comment = new NhomKinh.Features.Comments.Create.CommentData()
                {
