...
namespace NhomKinh
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connectionString = _config.GetValue<string>("ASPNETCORE_NhomKinh_ConnectionString") ??
            ...
            var databaseProvider = _config.GetValue<string>("ASPNETCORE_NhomKinh_DatabaseProvider");
            if (string.IsNullOrWhiteSpace(databaseProvider))
            {
                databaseProvider = DEFAULT_DATABASE_PROVIDER;
            }

            services.AddDbContext<NhomKinhContext>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, ILoggerFactory loggerFactory)
        {
            ...
            app.ApplicationServices.GetRequiredService<NhomKinhContext>().Database.EnsureCreated();
        }
    }
}