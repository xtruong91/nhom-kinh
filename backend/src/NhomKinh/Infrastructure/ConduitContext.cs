...
{
    public class NhomKinhContext : DbContext
    {
        private IDbContextTransaction _currentTransaction;

        public NhomKinhContext(DbContextOptions options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FollowedPeople>(b =>
            {
                ...
                // app.ApplicationServices.GetRequiredService<NhomKinhContext>().Database.EnsureCreated(); throws the following error:
